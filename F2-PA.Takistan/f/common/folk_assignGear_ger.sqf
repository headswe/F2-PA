...
_rifle = "G36a"; _riflemag = "ACE_30Rnd_556x45_S_G36";																						// Standard Riflemen (Spotter, HMG Assistant Gunner, MMG Assistant Gunner, Assistant Automatic Rifleman, MAT Assistant Gunner, HAT Assistant Gunner, MTR Assistant Gunner, Rifleman)

_carbine = "G36C"; _carbinemag = "ACE_30Rnd_556x45_S_G36"; 																					// Standard Carabineer (Medic, HMG Gunner, Rifleman (AT), Rifleman (AA), MAT Gunner, HAT Gunner, MTR Gunner, Carabineer)
...
_glrifle = "m8_carbineGL"; _glriflemag = "ACE_30Rnd_556x45_S_G36"; _glmag = "1Rnd_HE_M203";													// Rifle with GL and HE grenades (CO, DC, FTLs)
...
_bagmedium = "ACE_Backpack_TT";		// 8+ slots																								// Backpack for assistant gunners (AAR, AMMG, AMAT, AHAT), so that they don't have to drop ammo themselves
...
_SNrifle = "m8_sharpshooter"; _SNriflemag = "ACE_30Rnd_556x45_S_G36";																				// Sniper
