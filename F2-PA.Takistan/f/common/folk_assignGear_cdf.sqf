...
_rifle = "M16A2"; _riflemag = "ACE_30Rnd_556x45_S_Stanag";																					// Standard Riflemen (Spotter, HMG Assistant Gunner, MMG Assistant Gunner, Assistant Automatic Rifleman, MAT Assistant Gunner, HAT Assistant Gunner, MTR Assistant Gunner, Rifleman)
...
_glrifle = "ACE_AKS74P_GL"; _glriflemag = "ACE_30Rnd_545x39_S_AK"; _glmag = "1Rnd_HE_GP25";													// Rifle with GL and HE grenades (CO, DC, FTLs)
...
_AR = "ACE_RPK"; _ARmag = "ACE_75Rnd_545x39_S_RPK";																							// Automatic Rifleman
