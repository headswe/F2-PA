...
_rifle = "AK_74"; _riflemag = "ACE_30Rnd_545x39_S_AK";																						// Standard Riflemen (Spotter, HMG Assistant Gunner, MMG Assistant Gunner, Assistant Automatic Rifleman, MAT Assistant Gunner, HAT Assistant Gunner, MTR Assistant Gunner, Rifleman)
...
_glrifle = "AK_74_GL"; _glriflemag = "ACE_30Rnd_545x39_S_AK"; _glmag = "1Rnd_HE_GP25";												// Rifle with GL and HE grenades (CO, DC, FTLs)
